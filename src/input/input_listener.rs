use crate::{ButtonMask, InputMask, MotionMask, PlayerId};
use bevy::prelude::*;
use leafwing_input_manager::{prelude::*, *};

#[derive(Actionlike, PartialEq, Eq, Clone, Copy, Hash, Debug, Default, Component)]
pub enum OkiAction {
    #[default]
    A,
    B,
